...
<br><br>
    <div class="wrapper" style="margin-left:550px;">
      <div class="contact-form" style="">
        <div class="input-fields" style="color:#c5ecfd;">
           <h2>Feedback</h2> 
            ...
            <form role="form" method="post" id="reused_form">
                        ...
                        <div class="row">
                          ...
                          <div class="form-group">
                                            <div class="row">
                                              <label class="col-sm-3 control-label">Feedback Date</label>
                                                <div class="col-sm-9">
                                                  <input type="text" value="<?php echo $current_date;?>" name="feedback_date" class="form-control" readonly>
                                                </div>
                                            </div>
                                        </div>
                        <div class="row">
