...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          <a class="dropdown-item" href="http://localhost/Project/dates.php">Dates</a>
...
<div style="background-image:url('other.jpg'); opacity: 80%; height: 550px;">
  <h1 style="margin-left:580px; color:cyan;">INTRODUCTION</h1><br><br>
  <div style="margin-left: 450px;">
      <h4 style="margin-right: 500px; font-family:initial; color: honeydew; text-shadow: darkslategray;">
            This project is an initiative to create a software system for viewing, marketing, booking and managing the various venues and services provided by BMCC.<br> This project is divided into two parts: the user website and the admin android application.<br> The user website is used for marketing purposes and for sending booking requests by the user. It will be the consumer end of the software. The admin application is an android based app that will allow the admin to view, accept and reject the user request.<br> This software is made with the perspective of solving the problem of extra paperwork and lack of effective and efficient communication and transactions between the consumer and BMCC admin.
      </h4>
