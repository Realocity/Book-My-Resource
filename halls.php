...
<br><br>
<div class="card" style="width: 100%; height: 500px; background: url(halls2.jpg); background-size: cover;">
  <div class="card-body"><br><br><br><br><br><br>
    <h5 class="card-title" style="font-size:40px; font-weight: bold; color:#d3d3d3; ">Cyrus Poonawala Hall</h5>
    ...
    <a href="http://localhost/Project/cyrus.php" class="btn btn-primary">Read More</a>
  </div>
</div>
<br><br>
<div class="card text-center text-white" style="width: 100%; height: 500px; background: url(halls1.jpg); background-size: cover;">
  <div class="card-body"><br><br><br><br><br><br><br><br>
    <h5 class="card-title" style="font-size:40px; font-weight: bold; color:#d3d3d3; ">Tata Hall</h5>
    <p class="card-text" style="font-size:30px; font-weight: bold; color: white;">With supporting text below as a natural lead-in to additional content.</p>
    <a href="http://localhost/Project/tata.php" class="btn btn-primary">Read More</a>
  </div>
</div>
<br><br>
<div class="card text-right" style="width: 100%; height: 500px; background: url(halls3.jpg); background-size: cover;">
  <div class="card-body"><br><br><br><br><br><br>
    <h5 class="card-title" style="font-size:40px; font-weight: bold; color:#d3d3d3; ">Pittie Hall</h5>
    <p class="card-text" style="font-size:30px; font-weight: bold; color:white; ">With supporting text below as a natural lead-in to additional content.</p>
    <a href="http://localhost/Project/pittie.php" class="btn btn-primary">Read More</a>
  </div>
</div>
<br><br>
<div id="footer">
