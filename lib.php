...
<div class="card mb-3" style="background-color:#d3d3d3;">
  <img src="oth1.jpg" class="card-img-top" alt="..." style="width: 100%; height: 400px;">
  <div class="card-body">
    <h5 class="card-title" style="text-align:center; font-size: 45px; color:#02051A"><b>Library and Reading Hall</b></h5>
    <p class="card-text"></p>
