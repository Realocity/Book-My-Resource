...
<br><br>
<div class="card" style="width: 100%; height: 500px; background: url(labs1.jpg); background-size: cover;">
  <div class="card-body"><br><br><br><br><br><br>
    <h5 class="card-title" style="font-size:40px; font-weight: bold; color:#d3d3d3; ">MCA LAB</h5>
    ...
    <a href="http://localhost/Project/mca.php" class="btn btn-primary">Read More</a>
  </div>
</div>
<br><br>
<div class="card text-center text-white" style="width: 100%; height: 500px; background: url(labs2.jpg); background-size: cover;">
  <div class="card-body"><br><br><br><br><br><br><br><br>
    <h5 class="card-title" style="font-size:40px; font-weight: bold; color:#d3d3d3; ">BCOM LAB</h5>
    <p class="card-text" style="font-size:30px; font-weight: bold; color: white;">With supporting text below as a natural lead-in to additional content.</p>
    <a href="http://localhost/Project/bcom.php" class="btn btn-primary">Read More</a>
  </div>
</div>
<br><br>
<div class="card text-right" style="width: 100%; height: 500px; background: url(labs3.jpg); background-size: cover;">
  <div class="card-body"><br><br><br><br><br><br>
    <h5 class="card-title" style="font-size:40px; font-weight: bold; color:#d3d3d3; ">BCA LAB</h5>
    <p class="card-text" style="font-size:30px; font-weight: bold; color:white; ">With supporting text below as a natural lead-in to additional content.</p>
    <a href="http://localhost/Project/bca.php" class="btn btn-primary">Read More</a>
  </div>
</div>
<br><br>
<div id="footer">
